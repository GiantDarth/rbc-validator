...
[[ $(./rbc_validator_mpi --mode=chacha20 -rvca -m3 |& grep searched | cut -d' ' -f4) == 2763520 ]]
[[ $(./rbc_validator_mpi --mode=chacha20 -rvcaf -m3 |& grep searched | cut -d' ' -f4) == 2763520 ]]

[[ $(mpirun ./rbc_validator_mpi --mode=chacha20 -rvca -m3 |& grep searched | cut -d' ' -f4) == 2763520 ]]
[[ $(mpirun ./rbc_validator_mpi --mode=chacha20 -rvcaf -m3 |& grep searched | cut -d' ' -f4) == 2763520 ]]
