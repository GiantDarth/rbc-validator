...
[[ $(./rbc_validator --mode=ecc -rvca -m3 -t1 |& grep searched | cut -d' ' -f4) == 2796417 ]]
[[ $(./rbc_validator --mode=ecc -rvcaf -m3 -t1 |& grep searched | cut -d' ' -f4) == 2763520 ]]

[[ $(./rbc_validator --mode=ecc -rvca -m3 |& grep searched | cut -d' ' -f4) == 2796417 ]]
[[ $(./rbc_validator --mode=ecc -rvcaf -m3 |& grep searched | cut -d' ' -f4) == 2763520 ]]
