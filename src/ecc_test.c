...
int main() {
    unsigned char private_key[EC_PRIV_KEY_SIZE] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    ...
    unsigned char expected_public_key[EC_PUB_COMP_KEY_SIZE] = {
            ...
            0x02,
            // x
            0x7a, 0x59, 0x31, 0x80, 0x86, 0x0c, 0x40, 0x37, 0xc8, 0x3c, 0x12, 0x74, 0x98, 0x45,
