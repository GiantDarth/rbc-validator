...
/// system.
/// \param digest The output digest. It must be pre-allocated with at least the correct
/// digest size.
/// \param digest_size Either NULL for any non-XOF, or the wanted digest size when
...
/// then it will allocate and destroy a temporary context at the cost of performance.
/// \param md Which hash function to use.
/// \param msg The message to hash, must have at least msg_size bytes
/// allocated.
...
/// \param salt_size How big the salt
/// is. If salt is NULL, then this value is ignored.
