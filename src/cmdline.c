/*
  ...
  gengetopt --output-dir=src --default-optional --unnamed-opts
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->benchmark_help = gengetopt_args_info_help[6] ;
  args_info->all_help = gengetopt_args_info_help[7] ;
  args_info->count_help = gengetopt_args_info_help[8] ;
  args_info->fixed_help = gengetopt_args_info_help[9] ;
